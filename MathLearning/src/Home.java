...
public class Home extends javax.swing.JFrame {
    ...
    double result;
    String userId=welcome_page.userId;
    String question;
    String historyt=welcome_page.history;
    String name=welcome_page.name;
   
    int s;
    
    public Home() {
        score = welcome_page.score;
        initComponents();
    }
    ...
    public void scoreUpload(double score) throws ClassNotFoundException, SQLException{
         
             
       String query2 ="UPDATE `info` SET `score`= "+score+" WHERE `user` ='"+userId+"'";
    ...
    public void deleteAc() throws ClassNotFoundException, SQLException{
       
       
       String query2 ="DELETE FROM `info` WHERE user = '"+userId+"'";
       Class.forName("com.mysql.jdbc.Driver");
       Connection connection = (Connection)DriverManager.getConnection(welcome_page.url,welcome_page.dusername,welcome_page.dpassword);
       Statement statement = connection.createStatement();
    ...
    public void historyUploade() throws ClassNotFoundException, ClassNotFoundException, SQLException{
      
       
      String query2 ="UPDATE `info` SET `history`= '"+historyt+"' WHERE `user` ='"+userId+"'";
      Class.forName("com.mysql.jdbc.Driver");
       Connection connection = (Connection)DriverManager.getConnection(welcome_page.url,welcome_page.dusername,welcome_page.dpassword);
       Statement statement = connection.createStatement();
    ...
    private void initComponents() {
        ...
        deleteAc = new javax.swing.JButton();
        ...
        jPanel2.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 220, -1, -1));
        ...
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 240, -1, 22));
        ...
        jPanel2.add(start, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 640, 390));
        ...
        jPanel2.add(historydisplay, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 640, 390));
        ...
        logout.setBackground(new java.awt.Color(34, 49, 63));
        logout.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        logout.setForeground(new java.awt.Color(228, 241, 254));
        ...
        jPanel2.add(logout, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 350, 100, 30));
        ...
        deleteAc.setBackground(new java.awt.Color(34, 49, 63));
        deleteAc.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        deleteAc.setForeground(new java.awt.Color(228, 241, 254));
        deleteAc.setText("Delete Account");
        deleteAc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                deleteAcActionPerformed(evt);
            }
        });
        deleteAc.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                deleteAcKeyPressed(evt);
            }
        });
        jPanel2.add(deleteAc, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 350, 130, 30));
    ...
    private void deleteAcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteAcActionPerformed
    ...
    }//GEN-LAST:event_deleteAcActionPerformed

    private void deleteAcKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_deleteAcKeyPressed
        int p = JOptionPane.showConfirmDialog(null,"Do you want to delete your accout?","Delete",JOptionPane.YES_NO_OPTION);
       if(p==0){ try {
            deleteAc();
        } catch (Exception ex) {
    ...
    }//GEN-LAST:event_deleteAcKeyPressed
    ...
    private javax.swing.JButton deleteAc;
