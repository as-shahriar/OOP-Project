...
public class welcome_page extends javax.swing.JFrame {
   ...
   public static String url = "jdbc:mysql://127.0.0.1:3306/mydatabase";
    ...
    private void initComponents() {
        ...
        playoffline = new javax.swing.JButton();
        ...
        jLabel4.setText("Learn Math is an");
        ...
        jLabel5.setText("application that ");
        ...
        jLabel10.setText("Let's start learning!!!");
        ...
        jLabel11.setText("learn math easily.");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 220, -1, 20));

        playoffline.setBackground(new java.awt.Color(249, 105, 14));
        playoffline.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        playoffline.setForeground(new java.awt.Color(228, 241, 254));
        playoffline.setText("Play Offline");
        playoffline.setBorder(null);
        playoffline.setBorderPainted(false);
        playoffline.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                playofflineActionPerformed(evt);
            }
        });
        playoffline.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                playofflineKeyPressed(evt);
            }
        });
        jPanel1.add(playoffline, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 370, 100, 30));
    ...
    private void playofflineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_playofflineActionPerformed
        new Offline().setVisible(true);
        close();
    }//GEN-LAST:event_playofflineActionPerformed

    private void playofflineKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_playofflineKeyPressed
     if(evt.getKeyCode()==KeyEvent.VK_ENTER){
        new Offline().setVisible(true);
        close();
    }
    }//GEN-LAST:event_playofflineKeyPressed
       ...
       while(result.next()){
        ...
        if(duser.equals(user)){
            if(dpass.equals(pass)){
              ...
              score=Double.valueOf(result.getString("score"));
...
//               connection.close();
    ...
    private javax.swing.JButton playoffline;
